...
int main() {
	...
	bezierPoints.push_back(Vector3d(-120, 300, 0));
	bezierPoints.push_back(Vector3d(-60, 200, 0));
	bezierPoints.push_back(Vector3d(-120, 100, 0));
	bezierPoints.push_back(Vector3d(-60, 0, 0));
	Bezier* bezier = new Bezier(bezierPoints, 300, 100, Material(Vector3d(240, 32, 160), 0.3, 0.5, 0.3, 0.2, 1));
	scene->addP(bezier);
	RTEngine engine;

...
int main() {
	...
	Light* light1 = new CirclePlaneLight(Vector3d(255000000, 255000000, 255000000)*3);
	dynamic_cast<CirclePlaneLight*>(light1)->setPosition(Point(400, 300, -100), 30, Vector3d(0, 0, 1));
	scene->addL(light1);
	...
	scene->addP(new Sphere(Point(600, 100, 300), 100, Material(Vector3d(230, 224, 176), 0.3, 0.5, 0.3, 0.2, 1.33)));
	...
	//scene->addP(new Plane(Direction(0, 0, 1), -600, m3));
	...
	Bezier* bezier = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier2 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier3 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier4 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier5 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier6 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier7 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	...
	Bezier* bezier8 = new Bezier(bezierPoints, 300, 300, Material(Vector3d(87, 201, 0), 0.1, 0.9, 0.3, 0.2, 1));
	scene->addP(bezier);
	scene->addP(bezier2);
	scene->addP(bezier3);
	scene->addP(bezier4);

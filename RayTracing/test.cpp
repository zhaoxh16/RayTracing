...
int main() {
	...
	scene->addL(new Light(Point(150, 550, 500), 100, Material(Vector3d(125, 125, 125), 0.3, 0.5, 0.1, 0, 0)));
	scene->addL(new Light(Point(400, 590, 100), 100, Material()));
	scene->addP(new Sphere(Point(200, 200, 300), 100, Material(Vector3d(240, 32, 160), 0.3, 0.7, 0.5, 0.8, 1.33)));
	scene->addP(new Sphere(Point(500, 100, 300), 100, Material(Vector3d(87, 201, 0), 0.3, 0.7, 0.5, 0.8, 1.33)));
	scene->addP(new Sphere(Point(450, 300, 400), 150, Material(Vector3d(230, 224, 176), 0.3, 0.7, 0.5, 0.8, 1.33)));
	for (int i = 0; i < 5; ++i) {
		for (int j = 0; j < 5; ++j) {

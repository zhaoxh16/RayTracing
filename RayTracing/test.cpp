...
int main() {
	...
	myPri[4] = new Sphere(Point(200, 200, 300), 100, Material(Vector3d(240, 32, 160), 0.3, 0.5, 0.5,1.0,1.33));
	myPri[5] = new Sphere(Point(500, 100, 300), 100, Material(Vector3d(87, 201, 0), 0.3, 0.5, 0.5,1.0,1.33));
	myPri[6] = new Sphere(Point(450, 300, 400), 150, Material(Vector3d(230, 224, 176), 0.3, 0.5, 0.5,1.0,1.33));
	for (int i = 0; i < 5; ++i) {
		for (int j = 0; j < 5; ++j) {
